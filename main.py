...
speedLbl = tk.Label(text="Set Input Speed", font=("Arial", 35), bg="grey")
...
runButton = tk.Button(text="Run Test", padx =10, command= run_steady, font=("Arial", 35), bg="green")
...
speedEntry.grid(row=3, column=0, pady=(25, 25), padx=(200,0))
